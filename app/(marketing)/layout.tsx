          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm opacity-90">
                NASA engineer bringing aerospace precision to small business websites.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="mt-4 flex gap-4">
                <a href="https://github.com" className="hover:text-accent transition-colors" aria-label="GitHub">
                ...
                <a href="https://linkedin.com" className="hover:text-accent transition-colors" aria-label="LinkedIn">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
