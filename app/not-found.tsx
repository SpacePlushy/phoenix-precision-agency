        ...
        <div className="bg-card rounded-2xl shadow-xl p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 border border-accent text-accent px-6 py-3 rounded-lg font-medium hover:bg-accent/10 transition-colors"
            >
          ...
          <div className="text-sm text-muted-foreground">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/portfolio" className="text-accent hover:text-accent/80">
                Portfolio
              </Link>
